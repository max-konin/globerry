...
public class EventDao implements IEventDao
{
    ...
    {
	List<Event> result;
	Criteria criteria = sessionFactory.getCurrentSession().createCriteria(Event.class).add(Restrictions.eq("month", month))
		.createCriteria("cityList").add(Restrictions.eq("id", city.getId()));
