//version with working non redrawing button
                ...
                for (j = 0; j < arrln; j++) {
                    if (!((myArray[i][j] < 0) && (myArray[i + 1][j] < 0) && (myArray[i][j + 1] < 0) && (myArray[i + 1][j + 1] < 0))) {
                        if (((myArray[i][j] > 0) && (myArray[i + 1][j] > 0) && (myArray[i][j + 1] > 0) && (myArray[i + 1][j + 1] > 0))) { //&& (!(myArray[i][j] > 10)) //debag
                            ...
                            rect = paper.rect(i * blockWidth, j0 * blockHeight, blockWidth, (j - j0 + 1) * blockHeight); //if you are not using little array, please write (j - j0+1) its a bug=)
                        ...
                        //if (((myArray[i][j] < 0) && (myArray[i + 1][j] < 0) && (myArray[i][j + 1] < 0) && (myArray[i + 1][j + 1] < 0))) alert("123");
                        //circle = paper.circle(i * blockWidth, j * blockHeight, 5);
                        // circle.attr({ fill: 'pblock', opacity: 1, stroke: 'none' });

                        for (i2 = 0; i2 < arrln2; i2++) {
                            for (j2 = 0; j2 < arrln2; j2++) {
                                //circle = paper.circle(i * blockWidth + i2 * littleBlockWidth, j * blockHeight + j2 * littleBlockHeight, 1);
                                //circle.attr({ fill: 'red', opacity: vopacity, stroke: 'none' });
                                //if ((my2Array[i2][j2] < 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2][j2 + 1] < 0) && (my2Array[i2 + 1][j2 + 1] < 0)) {
                                // rect = paper.rect(i * blockWidth + i2 * littleBlockWidth, j * blockHeight + j2 * littleBlockHeight, littleBlockWidth, littleBlockHeight); //if you are not using little array, please write (j - j0+1) its a bug=)
                                // rect.attr({ fill: 'red', stroke: color, opacity: vopacity, 'stroke-opacity': vopacity / (3.3) });
                                //} //if(4-)
                                if ((my2Array[i2][j2] > 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2][j2 + 1] > 0) && (my2Array[i2 + 1][j2 + 1] > 0)) {
                                    var j0 = j2;
                                    while (((my2Array[i2][j2 + 1] > 0) && (my2Array[i2 + 1][j2 + 1] > 0) && (my2Array[i2][j2 + 2] > 0) && (my2Array[i2 + 1][j2 + 2] > 0)) && (j2 < arrln2)) j2++;
                                    rect = paper.rect(i * blockWidth + i2 * littleBlockWidth, j0 * littleBlockHeight + j * blockHeight, littleBlockWidth, (j2 - j0 + 1) * littleBlockHeight); //if you are not using little array, please write (j - j0+1) its a bug=)
                                    rect.attr({ fill: color, stroke: color, opacity: vopacity, 'stroke-opacity': vopacity / (3.3) });
                                    j2++;

                                    //rect = paper.rect(i * blockWidth + i2 * littleBlockWidth, j * blockHeight + j2 * littleBlockHeight, littleBlockWidth, littleBlockHeight); //if you are not using little array, please write (j - j0+1) its a bug=)
                                    //rect.attr({ fill: 'blue', stroke: color, opacity: vopacity, 'stroke-opacity': vopacity / (3.3) });
                                }
                                //=============11==============================================================
                                //i * blockWidth
                                ...
                                if (((my2Array[i2][j2] > 0) && (my2Array[i2][j2 + 1] > 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] < 0)) || ((my2Array[i2][j2] < 0) && (my2Array[i2][j2 + 1] < 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] > 0))) {
                                    line = undefined;
                                    line_s += 'M' + (i2 + (my2Array[i2][j2]) / (my2Array[i2][j2] - my2Array[i2 + 1][j2])) * littleBlockWidth + ',' + j2 * littleBlockHeight + 'L' + (i2 + (my2Array[i2][j2 + 1]) / (my2Array[i2][j2 + 1] - my2Array[i2 + 1][j2 + 1])) * littleBlockWidth + ',' + (j2 + 1) * littleBlockHeight;
                                    if (my2Array[i2][j2] > 0)
                                ...
                                //----===-=========================2222=========================
                                    ...
                                    if (((my2Array[i2][j2] > 0) && (my2Array[i2][j2 + 1] < 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] < 0)) || ((my2Array[i2][j2] < 0) && (my2Array[i2][j2 + 1] > 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] > 0))) {
                                        line = undefined;
                                        line_s += 'M' + (i2) * littleBlockWidth + ',' + (j2 + (my2Array[i2][j2]) / (my2Array[i2][j2] - my2Array[i2][j2 + 1])) * littleBlockHeight + 'L' + (i2 + 1) * littleBlockWidth + ',' + (j2 + (my2Array[i2 + 1][j2]) / (my2Array[i2 + 1][j2] - my2Array[i2 + 1][j2 + 1])) * littleBlockHeight;
                                        if (my2Array[i2][j2] > 0)
                                        ...
                                        if (((my2Array[i2][j2] > 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] < 0) && (my2Array[i2][j2 + 1] < 0)) || ((my2Array[i2][j2] < 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] > 0) && (my2Array[i2][j2 + 1] > 0))) {
                                            line = undefined;
                                            line_s += 'M' + (i2 + (my2Array[i2][j2]) / (my2Array[i2][j2] - my2Array[i2 + 1][j2])) * littleBlockWidth + ',' + j2 * littleBlockHeight + 'L' + (i2) * littleBlockWidth + ',' + (j2 + (my2Array[i2][j2]) / (my2Array[i2][j2] - my2Array[i2][j2 + 1])) * littleBlockHeight;
                                            if (my2Array[i2][j2] > 0)
                                            ...
                                            if (((my2Array[i2][j2] < 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] < 0) && (my2Array[i2][j2 + 1] < 0)) || ((my2Array[i2][j2] > 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] > 0) && (my2Array[i2][j2 + 1] > 0))) {
                                                line = undefined;
                                                line_s += 'M' + (i2 + (my2Array[i2][j2]) / (my2Array[i2][j2] - my2Array[i2 + 1][j2])) * littleBlockWidth + ',' + j2 * littleBlockHeight + 'L' + (i2 + 1) * littleBlockWidth + ',' + (j2 + (my2Array[i2 + 1][j2]) / (my2Array[i2 + 1][j2] - my2Array[i2 + 1][j2 + 1])) * littleBlockHeight;
                                                ...
                                                triangle.translate(i * blockWidth, j * blockHeight);
                                                triangle.attr({ fill: color, stroke: color, opacity: vopacity, 'stroke-opacity': vopacity / (3.3) });
                                            } //endif 1+ 3- (upperri2ght)
                                            else
                                                if (((my2Array[i2][j2] < 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] < 0) && (my2Array[i2][j2 + 1] > 0)) || ((my2Array[i2][j2] > 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] > 0) && (my2Array[i2][j2 + 1] < 0))) {
                                                    line = undefined;
                                                    line_s += 'M' + (i2 + (my2Array[i2][j2 + 1]) / (my2Array[i2][j2 + 1] - my2Array[i2 + 1][j2 + 1])) * littleBlockWidth + ',' + (j2 + 1) * littleBlockHeight + 'L' + (i2) * littleBlockWidth + ',' + (j2 + (my2Array[i2][j2]) / (my2Array[i2][j2] - my2Array[i2][j2 + 1])) * littleBlockHeight;
                                                    ...
                                                    if (((my2Array[i2][j2] < 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] > 0) && (my2Array[i2][j2 + 1] < 0)) || ((my2Array[i2][j2] > 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] < 0) && (my2Array[i2][j2 + 1] > 0))) {
                                                        line = undefined;
                                                        line_s += 'M' + (i2 + (my2Array[i2][j2 + 1]) / (my2Array[i2][j2 + 1] - my2Array[i2 + 1][j2 + 1])) * littleBlockWidth + ',' + (j2 + 1) * littleBlockHeight + 'L' + (i2 + 1) * littleBlockWidth + ',' + (j2 + (my2Array[i2 + 1][j2]) / (my2Array[i2 + 1][j2] - my2Array[i2 + 1][j2 + 1])) * littleBlockHeight;
                                                        ...
                                                        triangle.translate(i * blockWidth, j * blockHeight);
                                                        triangle.attr({ fill: color, stroke: color, opacity: vopacity, 'stroke-opacity': vopacity / (3.3) });
                                                    } //endif 1+ 3- (downri2ght)
                                                    else
                                                        if (((my2Array[i2][j2] > 0) && (my2Array[i2 + 1][j2] < 0) && (my2Array[i2 + 1][j2 + 1] > 0) && (my2Array[i2][j2 + 1] < 0)) || ((my2Array[i2][j2] < 0) && (my2Array[i2 + 1][j2] > 0) && (my2Array[i2 + 1][j2 + 1] < 0) && (my2Array[i2][j2 + 1] > 0))) {
                                                            // line = paper.path('M' + (i + (my2Array[i][j2 + 1]) / (my2Array[i][j2 + 1] - my2Array[i + 1][j2 + 1])) * littleBlockWidth + ',' + (j + 1) * littleBlockHeight + 'L' + (i + 1) * littleBlockWidth + ',' + (j + (my2Array[i + 1][j]) / (my2Array[i + 1][j] - my2Array[i + 1][j + 1])) * littleBlockHeight);
                                                            //line = paper.path('M' + (i + (my2Array[i][j + 1]) / (my2Array[i][j + 1] - my2Array[i + 1][j + 1])) * blockWidth + ',' + (j + 1) * blockHeight + 'L' + (i) * blockWidth + ',' + (j + (my2Array[i][j]) / (my2Array[i][j] - my2Array[i][j + 1])) * blockHeight);
                                                            //line_s += 'M' + (i + (my2Array[i][j + 1]) / (my2Array[i][j + 1] - my2Array[i + 1][j + 1])) * blockWidth + ',' + (j + 1) * blockHeight + 'L' + (i + 1) * blockWidth + ',' + (j + (my2Array[i + 1][j]) / (my2Array[i + 1][j] - my2Array[i + 1][j + 1])) * blockHeight;
                                                            //line_s += 'M' + (i + (my2Array[i][j + 1]) / (my2Array[i][j + 1] - my2Array[i + 1][j + 1])) * blockWidth + ',' + (j + 1) * blockHeight + 'L' + (i + 1) * blockWidth + ',' + (j + (my2Array[i + 1][j]) / (my2Array[i + 1][j] - my2Array[i + 1][j + 1])) * blockHeight;
                                                            //line.attr({ fill: circleColor });
                                                        } //endif 1+ 3- (downright)
